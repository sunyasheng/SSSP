...
def batch_single_view_cam_params_generate(device, cam_pivot, cam_radius, fov_deg, angle_y, batch_size):
    batch_camera_params = []
    for _ in range(batch_size):
        one_camera_params = single_view_cam_params_generate(device, cam_pivot, cam_radius, fov_deg, angle_y)
        batch_camera_params.append(one_camera_params)
    batch_camera_params = torch.cat(batch_camera_params, dim=0)
    return batch_camera_params


def single_view_cam_params_generate(device, cam_pivot, cam_radius, fov_deg, angle_y):
