...
class RaySampler(torch.nn.Module):
    ...
    def forward(self, cam2world_matrix, intrinsics, resolution, bbox=None):
        """
        ...
        if bbox is not None:
            # uv = uv[:, bbox[0]-bbox[2]//2:bbox[0]+bbox[2]//2, bbox[1]-bbox[3]//2:bbox[1]+bbox[3]//2]
            uv = uv[:,  bbox[1]-bbox[3]//2:bbox[1]+bbox[3]//2, bbox[0]-bbox[2]//2:bbox[0]+bbox[2]//2]
