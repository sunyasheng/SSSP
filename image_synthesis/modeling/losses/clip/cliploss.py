### https://github.com/yael-vinker/CLIPasso/blob/cff8e2627eca2dc53569004544b04d9490ac96eb/models/loss.py

import collections
import image_synthesis.modeling.networks.third_party.CLIPasso.CLIP_.clip as clip
import torch
